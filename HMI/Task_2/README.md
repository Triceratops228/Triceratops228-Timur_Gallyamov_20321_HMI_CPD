...
Как работает алгоритм Дейкстры: создает словарь, где хранятся веса всех рёбер графа. Все рёбра имеют вес, равный бесконечности, кроме первого ребра, где вес установлен в 0. Алгоритм использует очередь с приоритетом для непрерывного выбора вершины с минимальным расстоянием из очереди. Для каждой выбранной вершины обновляются расстояния до её соседей, если находится более короткий путь. Процесс продолжается до тех пор, пока очередь не станет пустой. После вычисления расстояний алгоритм восстанавливает кратчайший путь от начальной вершины до конечной. Он перемещается от конечной вершины к начальной, используя информацию, сохраненную в previous_vertices. Наконец, код строит список рёбер, образующих кратчайший путь, перебирая вершины в пути и находя соответствующие рёбра в графе.
